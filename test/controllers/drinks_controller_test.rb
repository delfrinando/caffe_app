...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { description: @drink.description, title: @drink.title } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { description: @drink.description, title: @drink.title } }

...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { grande: @price.grande, id_drinks: @price.id_drinks, tall: @price.tall, venti: @price.venti } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { grande: @price.grande, id_drinks: @price.id_drinks, tall: @price.tall, venti: @price.venti } }
